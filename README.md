...
- Create and manage customer accounts through a RESTful API
- Apply Agile practices using a Kanban board and sprint planning
- Use TDD to build reliable service functionality
- Maintain high test coverage
- Automate testing and linting with GitHub Actions
- Secure the service using Flask-Talisman and Flask-CORS
- Containerize the application with Docker
- Deploy the service to Kubernetes/OpenShift
- Automate delivery using a Tekton pipeline
